...
function RegisterDetailContent() {
  ...
  useEffect(() => {
    ...
    // FOUND: start analysis from stored photo
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      alert(e.message ?? "등록 실패. 잠시 후 다시 시도해주세요.");
    } finally {
      setLoading(false);
  ...
  return (
    <div className="min-h-dvh bg-app-bg flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto px-6 pt-2 pb-24">
        ...
        <div className="bg-white rounded-[10px] p-3 shadow-sm">
          ...
          <div className="mb-3.5">
            ...
            <div className="h-11 bg-app-gray-light border border-app-border rounded-[10px] flex items-center px-2.5 gap-2">
      ...
      {/* CTA */}
      <div className="bg-app-bg px-7 pt-3 pb-6">
        <button
