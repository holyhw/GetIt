  ...
  return (
    <div className="min-h-dvh bg-app-bg md:pt-[72px]">
      ...
      <div className="md:max-w-[1200px] md:mx-auto">
        {/* 헤더 */}
        <div className="flex items-center px-6 pt-8 pb-0 md:pt-6">
          <button onClick={() => router.back()} className="cursor-pointer bg-transparent border-none p-1 md:hidden">
          ...
          <button
            ...
            className="hidden md:flex items-center gap-2 px-5 h-[38px] rounded-[10px] text-sm font-semibold text-white cursor-pointer border-none"
          ...
          <div className="w-[11px] md:hidden" />
        </div>
        ...
        {loading ? (
          ...
          <div className="px-5 pt-5 pb-32 grid grid-cols-2 gap-x-[19px] gap-y-5 md:grid-cols-4 md:gap-5 md:px-6">
            {filtered.map((item) => (
      ...
      {/* 모바일 하단 CTA */}
      <div className="md:hidden fixed bottom-0 left-0 right-0 bg-app-bg px-7 pt-3 pb-6 z-10">
